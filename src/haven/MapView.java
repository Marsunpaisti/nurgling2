...
public class MapView extends PView implements DTarget, Console.Directory {
    ...
    public static class MapRaster extends RenderTree.Node.Track1 {

	public MapRaster(MCache map, int view)
	{
		this.map = map;
		this.view = view;
	}
	...
	protected abstract class Grid<T> extends RenderTree.Node.Track1 {
	    final Map<Coord, Pair<T, RenderTree.Slot>> cuts = new HashMap<>();
	    final boolean position;
	    public Loading lastload = new Loading("Initializing map...");

	    Grid(boolean position) {
		this.position = position;
	    }

	    public Grid() {this(true);}

	    protected abstract T getcut(Coord cc);
	...
	final Grid main = new Grid<MapMesh>() {
		protected MapMesh getcut(Coord cc) {
	...
	private Terrain() {
		super(glob.map, MapView.this.view);
	}
	...
	public void addCustomOverlay(Integer id){
		NOverlay n;
