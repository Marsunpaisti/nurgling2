...
public class NRecentActionsPanel extends Widget {
    ...
    public synchronized void addBotAction(String botPath, Action botAction, boolean disStacks) {
        addBotAction(botPath, botAction, disStacks ? BotDescriptor.StackMode.DISABLED : BotDescriptor.StackMode.UNCHANGED);
    }
    ...
    private static class RecentAction {
        ...
        RecentAction(MenuGrid.Pagina pagina, Action botAction, String resourceName, String botPath, boolean disStacks) {
            this(pagina, botAction, resourceName, botPath, disStacks ? BotDescriptor.StackMode.DISABLED : BotDescriptor.StackMode.UNCHANGED);
        }
